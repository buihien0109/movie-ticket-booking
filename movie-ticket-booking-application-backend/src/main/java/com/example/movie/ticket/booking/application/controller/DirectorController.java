...
import com.example.movie.ticket.booking.application.service.DirectorService;
...
public class DirectorController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> updateDirector(@PathVariable Integer id, @Valid @RequestBody UpsertDirectorRequest request) {
