                                ...
                                <div className="submenu fadeInUp absolute hidden group-hover:block" style={{ width: "340px" }}>
                                    <div className="grid grid-cols-1 gap-2 rounded border border-gray-200 bg-white p-3 shadow-xl">
                                        {auth.auth?.role === "ADMIN" && (
                                            <NavLink to={"/admin/dashboard"} className="group flex flex-row flex-nowrap items-center rounded-md px-2 py-2  hover:bg-pink-100 hover:bg-opacity-50  text-gray-600 hover:text-pink-700">
