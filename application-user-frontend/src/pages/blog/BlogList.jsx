        ...
        <>
            ...
            <div className="max-w-6xl mx-auto py-7">
                <div className="my-6 pb-8">
                    <h1 className="mb-1 text-3xl font-bold text-gray-900 md:mb-4 md:text-5xl">Blog Phim Ảnh</h1>
                    <h2 className="max-w-3xl text-md text-gray-500 md:text-lg">Cập nhật các Blog về phim ảnh hay nhất trên thị trường với đầy đủ thể loại, quốc gia. Giải mã những nội dung phim gây tò mò và hấp dẫn.</h2>
                </div>
