        ...
        <>
            ...
            <div className="max-w-6xl mx-auto py-7">
                <div className="my-6 pb-8">
                    <h1 className="mb-1 text-3xl font-bold text-gray-900 md:mb-4 md:text-5xl">Netflix</h1>
                    <h2 className="max-w-3xl text-md text-gray-500 md:text-lg">Top phim Netflix hay, hấp dẫn và cập nhật liên tục</h2>
                </div>
                        ...
                        <div className="sticky top-20">
                            <div className="mt-8 rounded-lg bg-pink-50 px-4 py-5 lg:mt-0 lg:bg-white lg:px-0 lg:py-0">
                                ...
                                <div className="grid grid-cols-1">
                                    <ListBlogMostView type={"PHIM_NEFLIX"} />
                                </div>
                            </div>
                        </div>
                    </div>
...
export default BlogPhimNetflix